...
def main():
    ...
    s1=float(input("Enter the length of side 1 in inches: "))
    s2=float(input("Enter the length of side 2 in inches: "))
    s3=float(input("Enter the length of side 3 in inches: "))
